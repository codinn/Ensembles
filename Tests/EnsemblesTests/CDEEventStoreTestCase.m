...
+ (NSBundle *)bundle {
    NSString *bundleName = @"Ensembles_EnsemblesTests";
    
    NSArray<NSURL*> *candidates = @[
        NSBundle.mainBundle.resourceURL,
        [NSBundle bundleForClass:[CDEEventStoreTestCase class]].resourceURL,
...
- (void)setUp
{
    ...
    // Event store
    NSURL *modelURL = [ENSEMBLES_SWIFTPM_MODULE_BUNDLE() URLForResource:@"CDEEventStoreModel" withExtension:@"momd"];
    ...
    // Test Coordinator
    testModelURL = [[CDEEventStoreTestCase bundle] URLForResource:@"CDEStoreModificationEventTestsModel" withExtension:@"momd"];
